...
[[ -f "$ROOT/source/.config/.utility.sh" ]] && source "$ROOT/source/.config/.utility.sh" || exit
...
insy "$ROOT/source/.config/.utility.sh" "$HOME/.config/.utility.sh"
...
insy "$ROOT/source/.config/bash/prompt.sh" "$HOME/.config/bash/prompt.sh"
